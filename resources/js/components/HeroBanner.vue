...
export default{
    props:{
        ...
        banners: [
            ...
            {id: 3,image: '/images/banner-3.jpg', title: 'Делаем добро вместе', description: 'С каждого построенного дома мы перечисляем часть средств в благотворительные фонды нашего города, ведь добро начинается с каждого'},
        ],
        banner: 1
    })
}
