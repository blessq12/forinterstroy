...
export default{
    props:{
        ...
        banners: [
            ...
            {id: 2,image: '/images/choise-freedom.jpg', title: 'Свобода решать', description: 'Если вы считаете себя человеком с яркими убеждениями, цените свободу слова и выбора, противитесть всевозможным ограничениям, мы предлагаем вам получить свободу выбора'},
            {id: 3,image: '/images/choise-freedom.jpg', title: 'Делаем добро вместе', description: 'С каждого построенного дома мы перечисляем часть средств в благотворительные фонды нашего города, ведь добро начинается с каждого'},
        ],
        banner: 1
    })
}
